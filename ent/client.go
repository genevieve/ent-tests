...
// QuerySource queries the source edge of a FriendRequest.
func (c *FriendRequestClient) QuerySource(fr *FriendRequest) *UserQuery {
...
// QueryDestination queries the destination edge of a FriendRequest.
func (c *FriendRequestClient) QueryDestination(fr *FriendRequest) *UserQuery {
	query := &UserQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := fr.ID
		step := sqlgraph.NewStep(
...
// QueryOutgoingFriendRequests queries the outgoing_friend_requests edge of a User.
func (c *UserClient) QueryOutgoingFriendRequests(u *User) *FriendRequestQuery {
	query := &FriendRequestQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := u.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(user.Table, user.FieldID, id),
...
// QueryIncomingFriendRequests queries the incoming_friend_requests edge of a User.
func (c *UserClient) QueryIncomingFriendRequests(u *User) *FriendRequestQuery {
	query := &FriendRequestQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := u.ID
		step := sqlgraph.NewStep(
